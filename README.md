...
# Greenthumb Nursery 管理システム（日本語）

本リポジトリは、Java Swing と MySQL によるデスクトップ型植物園（ナーサリー）管理アプリケーションです。管理者、スタッフ、顧客の各役割に対応し、在庫・注文管理・レポート機能を備えています。

クイックスタート
1. MySQL を起動し、SQL をインポート:
...
詳細な手順は README.md（英語）を参照してください。  
<img width="429" height="409" alt="Screenshot 2025-11-02 at 23 43 37" src="https://github.com/user-attachments/assets/fb526015-47b9-44a8-aaf0-fcfe9763ec87" />
<img width="425" height="410" alt="Screenshot 2025-11-02 at 23 44 44" src="https://github.com/user-attachments/assets/71cc89db-0e0a-474b-b407-a6564b8936a3" />
<img width="1280" height="734" alt="Screenshot 2025-11-02 at 23 45 37" src="https://github.com/user-attachments/assets/da8941b9-25b3-4b1c-860d-c27b7f5881e8" />
<img width="1280" height="726" alt="Screenshot 2025-11-02 at 23 46 05" src="https://github.com/user-attachments/assets/62cf85c7-f4bd-4af9-92fd-0277b05a1c10" />
